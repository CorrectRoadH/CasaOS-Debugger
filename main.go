//go:generate bash -c "mkdir -p codegen && go run github.com/deepmap/oapi-codegen/v2/cmd/oapi-codegen@v2.1.0 -generate types,server,spec -package codegen api/debugger/openapi.yaml > codegen/debugger_api.go"
...
import (
	...
	"github.com/CorrectRoadH/CasaOS-Debugger/common"
	"github.com/CorrectRoadH/CasaOS-Debugger/config"
	"github.com/CorrectRoadH/CasaOS-Debugger/route"
...
var (
	...
	//go:embed api/debugger/openapi.yaml
	_docYAML string
